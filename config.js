const nameGirl = "For Thũy Ngân";
// const giftUrl = 'http://nodemy.vn';
const eventName = "Chúc may mắn";
const titleCard = "Nguyễn Thị Thũy Ngân";
const contentCard = "Chúc chị thi tốt . Uy tín!";
